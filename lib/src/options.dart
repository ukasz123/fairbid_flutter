...
class Options {
  ...
  Map<String, dynamic> _toMap() => {
        ...
        "logging": (loggingLevel != null && (loggingLevel == LoggingLevel.verbose || loggingLevel == LoggingLevel.info) || (loggingLevel == null && debugLogging)),
        "loggingLevel": loggingLevel?.index ?? (debugLogging ? LoggingLevel.verbose.index : LoggingLevel.silent.index),
      };
}
